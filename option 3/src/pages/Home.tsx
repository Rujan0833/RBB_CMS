  ...
  heroFeatures: [
    {
      ...
      subtitle: "Authorized by SEBON for securities trading"
    },
    {
      icon: "CheckCircle2",
      title: "NEPSE Member",
      subtitle: "Direct access to Nepal Stock Exchange"
    },
    {
      icon: "CheckCircle2",
      title: "Expert Support",
      subtitle: "Dedicated team to guide your investments"
    }
  ],
  trustIndicators: [
    {
      icon: "Shield",
      title: "Trusted",
      description: "SEBON licensed broker with proven track record"
    },
    {
      icon: "TrendingUp",
      title: "Professional",
      description: "Expert guidance for your investment journey"
    },
    {
      icon: "Users",
    ...
    },
    {
      icon: "Award",
      title: "Compliant",
      description: "Strict adherence to regulatory standards"
    }
  ],
  ...
  servicePreviews: [
    {
      ...
      description: "Buy and sell shares on Nepal Stock Exchange with our secure and efficient trading platform."
    },
    {
      title: "Online Trading Support",
      description: "Access NEPSE from anywhere with our online trading assistance and technical support."
    },
    {
      title: "DEMAT Services",
      description: "Complete assistance with DEMAT account setup and MeroShare account management."
    }
  ],
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {content.servicePreviews.map((service: any, index: number) => (
